...
def main():
    try:
        palabrasAnalizadas = {}
        BasedeDatos.cargarDiccionario(palabrasAnalizadas)

        while True:
            print("Funciones a realizar: \n")
            print ("1 = Silabear una palabra.\n")
            print ("2 = Entonar una palabra.\n")
            print ("exit = salir.\n")
            entrada = input("funcion> ")
            if  entrada == "1" :
                interpreteComandos(1,palabrasAnalizadas)
            elif entrada == "2":
                interpreteComandos(2,palabrasAnalizadas)
            elif entrada == "exit":
                interpreteComandos(4,palabrasAnalizadas)
            else:
                print("Escoja una opcion valida\n")
    except KeyboardInterrupt:
        Registrar(palabrasAnalizadas)
"""
